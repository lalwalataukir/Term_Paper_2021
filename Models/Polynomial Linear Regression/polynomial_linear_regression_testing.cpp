...
int main()
{
    ...
    vector<long double> coefficients = {0.012475, 0.478038, 0.019002, -0.098446, -0.389872, -0.008414, 0.125206, 0.316206, 0.109285};
    ...
    for (int i = 0 ; i < N ; i++)
    {
        ...
        value = value + coefficients[4] * area_mean[i] * area_mean[i];
        value = value + coefficients[5] * smoothness_mean[i] * smoothness_mean[i];
        value = value + coefficients[6] * compactness_mean[i] * compactness_mean[i];
        value = value + coefficients[7] * concave_points_mean[i] * concave_points_mean[i];
